...
export class CategoryDeviceService {
  ...
  public datatables(value: CategoryWarna, datatablesParameters: any) {
    ...
    return this._http
      .post<DatatablesModelResponse>(
        `${environment.supportDeviceApi}/master/category-warna/datatables`,
        value, {params: params}
      );
  }

  public save(value: CategoryWarna) {
    return this._http.post(`${environment.supportDeviceApi}/master/category-device/`, value);
  }

  public update(value: CategoryWarna) {
